# This class creates both outgoing messages from TopDoc Chat and echo outgoing messages based on the flag `outgoing_echo`
# Assumptions
# 1. Incase of an outgoing message which is echo, source_id will NOT be nil,
#    based on this we are showing "not sent from TopDoc Chat" message in frontend
